...
namespace mcs::core::control::command::file
{
  struct Write
  {
    ...
    storage::Parameter _parameter_file_write;
...
{
  template<>
    struct formatter<mcs::core::control::command::file::Write>
  {
    ...
    template<typename FormatContext>
      constexpr auto format
        ( mcs::core::control::command::file::Write const&
        , FormatContext& ctx
...
{
  template<>
    struct Implementation<mcs::core::control::command::file::Write>
  {
    using Type = mcs::core::control::command::file::Write;
...
{
  template<>
    struct Read<mcs::core::control::command::file::Write>
  {
