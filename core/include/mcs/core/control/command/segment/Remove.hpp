...
{
  template<>
    struct formatter<mcs::core::control::command::segment::Remove>
  {
    ...
    template<typename FormatContext>
      constexpr auto format
        ( mcs::core::control::command::segment::Remove const&
        , FormatContext& ctx
...
{
  template<>
    struct Implementation<mcs::core::control::command::segment::Remove>
  {
    using Type = mcs::core::control::command::segment::Remove;
...
{
  template<>
    struct Read<mcs::core::control::command::segment::Remove>
  {
