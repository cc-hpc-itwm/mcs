...
namespace
{
  auto collection_exists_main (mcs::util::Args args) -> int
  {
    if (args.size() != 3)
    {
...
{
  return mcs::util::main (argc, argv, collection_exists_main);
}
